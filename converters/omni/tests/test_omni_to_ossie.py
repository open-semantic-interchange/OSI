...
"""Unit tests for the Omni -> Ossie importer."""
...
from ossie_omni import ConversionError, convert_omni_to_ossie
...
def test_non_equi_join_is_stashed_not_converted():
    # A range join is valid in Omni but has no Ossie relationship form; it is
