...
def test_basic_conversion(ossie_tpcds_dict: dict):
    """Verify basic structure of Ossie → GoodData conversion."""
    result = ossie_to_gooddata(ossie_tpcds_dict, data_source_id="tpcds")
...
def test_dataset_ids(ossie_tpcds_dict: dict):
...
def test_date_dimension_detected(ossie_tpcds_dict: dict):
...
def test_dimension_fields_become_attributes(ossie_tpcds_dict: dict):
...
def test_non_dimension_fields_become_facts(ossie_tpcds_dict: dict):
...
def test_maql_expression_detection(ossie_tpcds_dict: dict):
...
def test_grain_from_primary_key(ossie_tpcds_dict: dict):
...
def test_data_source_table_id(ossie_tpcds_dict: dict):
