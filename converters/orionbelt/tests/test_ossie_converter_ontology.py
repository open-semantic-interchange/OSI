...
"""Tests for the OBML → Ossie **ontology** converter (OBMLtoOssieOntology).
...
to Ossie multiplicity, and that the documented gaps (many-to-many, composite keys,
...
class TestOntologyGaps:
    def test_many_to_many_skipped_with_warning(self) -> None:
        ...
        c = conv.OBMLtoOssieOntology(obml)
        doc = c.convert()
